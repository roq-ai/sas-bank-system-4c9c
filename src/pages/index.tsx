...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`SAS Bank System`}</title>

        <meta
          name="description"
          content="Experience seamless banking with SAS Bank System - Your one-stop solution for secure transactions, bill payments, credit card management and much more."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless banking with SAS Bank System - Your one-stop solution for secure transactions, bill payments, credit card management and much more.`}
            </Text>
            <Box
