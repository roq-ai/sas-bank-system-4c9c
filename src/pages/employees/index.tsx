  ...
  const columns: ColumnType[] = [
    ...
    { id: 'position', header: 'Position', accessorKey: 'position' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.date_hired ? format(parseISO(record?.date_hired as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'date_terminated',
      header: 'Date Terminated',
      accessorKey: 'date_terminated',
      cell: ({ row: { original: record } }: any) =>
        record?.date_terminated ? format(parseISO(record?.date_terminated as unknown as string), 'dd-MM-yyyy') : '',
    },
