          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Date Hired"
                  text={data?.date_hired ? format(parseISO(data?.date_hired as unknown as string), 'dd-MM-yyyy') : ''}
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.date_terminated
                      ? format(parseISO(data?.date_terminated as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
