...
export function TransactionListPage(props: TransactionListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'transaction_description', header: 'Transaction Description', accessorKey: 'transaction_description' },
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/customers/view/${record.customer?.id}`}>
              {record.customer?.account_number}
            </Link>
          ),
        }
      : null,
