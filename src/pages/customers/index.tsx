...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        relations: ['user', 'bill.count', 'transaction.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['account_number.contains', 'account_type.contains', 'credit_card_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'credit_card_status', header: 'Credit Card Status', accessorKey: 'credit_card_status' },
    { id: 'credit_card_limit', header: 'credit_card_limit', accessorKey: 'credit_card_limit' },
