...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer.update': {
    roles: ['bank-manager', 'bank-employee'],
  ...
  'transaction.create': {
    ...
    tenantPath: ['bank', 'user', 'customer', 'transaction'],
    userPath: [],
  },
  'employee.update': {
    roles: ['bank-manager', 'bank-owner'],
    key: 'employee-customer-assistance',
    tenantPath: ['bank', 'user', 'employee'],
    userPath: [],
  },
};
